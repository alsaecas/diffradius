...
def _stage_payload(tmp_path: Path, mode: str, fingerprint: str = "frozen") -> dict:
        ...
        cases.append(
            {
                ...
                "title": case_id,
                "hard": index in {0, 1},
                "expected": [{"category": "other", "paths": ["app/a.py"]}],
                "report": {"decision": "block", "summary": "x", "findings": []},
                "score": {
                    "true_positives": 1 if index == 0 else 0,
                    "false_positives": 0,
                    "false_negatives": 0 if index == 0 else 1,
                    "perfect": index == 0,
                    "expected_count": 1,
                },
                "usage": {
                ...
                "trajectory_path": _trajectory(
                    tmp_path / "raw-trajectories" / mode / f"{case_id}.json",
                    f"{mode}-{case_id}",
                ),
            }
        )
    return {
        ...
        "aggregate": {
            ...
            "precision": 0.5,
            "f1": 0.5,
            "perfect_case_rate": 0.1,
            "regression_case_detection_rate": 0.5,
            "safe_case_accuracy": 1.0,
            "true_positives": 1,
            "false_positives": 0,
            "false_negatives": 9,
            "regression_cases": 10,
