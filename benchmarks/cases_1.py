...
CASES = (
    Case(
        ...
        ticket='Stop swallowing OrganizationLookupError in load_roles so API callers can surface failures; existing UI flows must remain resilient to lookup failures.',
